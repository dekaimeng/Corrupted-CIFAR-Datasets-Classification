...
dataDir = os.path.join('Datasets', 'cifar-10-batches-py') # data path
noisyLabelFile = os.path.join('.', 'Datasets', '{}_noisy_labels_task2.json'.format(dataset)) # noisy label file
noiseLabelArray = np.array(json.load(open(noisyLabelFile, "r"))) # load the noisy labels
