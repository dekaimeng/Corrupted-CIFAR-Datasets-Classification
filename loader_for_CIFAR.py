...
class cifar_dataset(Dataset):
    def __init__(self, dataset, root_dir, transform, mode, noise_file=''):
        ...
        self.transition = {
            ...
            6: 6,
            8: 8
        }  # class transition for asymmetric noise for cifar10
...
class simple_cifar_dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return img, target, index, self.data[index, ...]
...
if __name__ == '__main__':
    ...
    data_path = 'Datasets\cifar-10-batches-py'  # path to the data file (don't forget to download the feature data and also put the noisy label file under this folder)
